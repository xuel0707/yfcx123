...
export default class SpringBootGenerator extends BaseApplicationGenerator {
    ...
    get composing() {
        return this.asComposingTaskGroup({
            async composing() {
                const { applicationType, databaseType, messageBroker, searchEngine, websocket, cacheProvider, testFrameworks, feignClient, enableSwaggerCodegen, } = this.jhipsterConfigWithDefaults;
