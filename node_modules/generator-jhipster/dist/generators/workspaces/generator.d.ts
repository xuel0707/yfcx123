...
export default class WorkspacesGenerator extends BaseWorkspacesGenerator {
    workspaces: any;
    generateApplications: any;
    generateWith: any;
    entrypointGenerator: any;
    generateWorkspaces: any;
    ...
    get loading(): import("../../lib/types/base/tasks.js").GenericTaskGroup<any, import("../../lib/types/base/tasks.js").TaskParamWithControl, "checkWorkspaces">;
    get loadingWorkspaces(): import("../../lib/types/base/tasks.js").GenericTaskGroup<any, import("../../lib/types/base/tasks.js").TaskParamWithControl, "loadConfig" | "configurePackageManager">;
    get writing(): import("../../lib/types/base/tasks.js").GenericTaskGroup<any, import("../../lib/types/base/tasks.js").TaskParamWithControl, "writing">;
    get postWriting(): import("../../lib/types/base/tasks.js").GenericTaskGroup<any, import("../../lib/types/base/tasks.js").TaskParamWithSource<any>, "generatePackageJson">;
    getOtherScripts(): {
