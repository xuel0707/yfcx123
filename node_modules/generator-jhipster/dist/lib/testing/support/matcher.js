 ...
 */
export const matchWrittenFiles = (title, expectedFilesGetter, shouldMatch, runResult = result) => [
 ...
 */
export const matchWrittenConfig = (title, config, shouldMatch, runResult = result) => [
